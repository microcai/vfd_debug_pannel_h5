...
export class VfdService {
  ...
  private createRegisterMap(): void {
    this.registers = {
      ...
      0x14: { name: 'outputPower', size: 4, type: 'float32', value: 0 },
      0x18: { name: 'iq', size: 4, type: 'float32', value: 0 },
      0x1C: { name: 'id', size: 4, type: 'float32', value: 0 },
      0x20: { name: 'vbus', size: 4, type: 'float32', value: 0 },
      0x24: { name: 'curFreq', size: 4, type: 'float32', value: 0 },
      0x28: { name: 'curTorque', size: 4, type: 'float32', value: 0 },
      0x2C: { name: 'curSpeed', size: 4, type: 'float32', value: 0 },
      0x30: { name: 'curPosition', size: 4, type: 'float32', value: 0 },
      0x34: { name: 'NTCtemp', size: 2, type: 'float16', value: 0 },
  ...
  private updateDataSubject(): void {
    const data: VFDData = {
      ...
      power: this.registers[0x14]?.value || 0,
      current: this.registers[0x18]?.value || 0,
      reactiveCurrent: this.registers[0x1c]?.value || 0,
      voltage: this.registers[0x20]?.value || 0,
      frequency: this.registers[0x24]?.value || 0,
      torque: this.registers[0x28]?.value || 0,
      speed: this.registers[0x2C]?.value || 0,
      position: this.registers[0x30]?.value || 0,
      NTCtemp: this.registers[0x34]?.value || 0,
